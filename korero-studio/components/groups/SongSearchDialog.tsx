...
export default function SongSearchDialog({ open, onOpenChange, onSubmit }: SongSearchDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="rounded-3xl border-border max-h-[85vh] flex flex-col overflow-hidden p-0 w-[calc(100vw-1.5rem)] sm:w-[calc(100vw-2rem)] max-w-[380px] sm:max-w-md md:max-w-lg left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
